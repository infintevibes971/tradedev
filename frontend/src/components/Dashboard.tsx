...
export function Dashboard({ health, agents, messages, strategies, onSpawn, onGoToSettings }: Props) {
          ...
          <div className="flex items-center gap-3">
            ...
            {onGoToSettings && (
              <button
                ...
                className="flex items-center gap-1.5 text-[10px] text-gray-500 hover:text-gray-200 bg-gray-800/50 hover:bg-gray-800 px-2.5 py-1.5 rounded-lg transition"
