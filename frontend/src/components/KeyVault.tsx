      ...
      {user && (
        <div className="px-4 py-2 border-b border-gray-700/50">
          <div className="flex items-center justify-between">
            <span className="text-xs text-gray-400">Signed in as <span className="text-gray-200 font-medium">{user.username}</span></span>
            <button
              onClick={onLogout}
              className="text-[10px] px-2.5 py-1 rounded bg-gray-800 text-gray-400 hover:text-red-400 hover:bg-red-900/20 transition"
            >
              Logout
            </button>
          </div>
                ...
                <div className="mb-4 pb-4 border-b border-gray-700/50">
                  <AddKeyForm
                    ...
                    onAdded={() => {
                      ...
                      // Auto-connect immediately after adding a key
                      connectExchanges();
                    }}
                  />
                </div>
